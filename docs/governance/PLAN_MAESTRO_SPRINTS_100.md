...
| **S12**| Rendimiento (code-splitting) y auditoría de dependencias (`exceljs`) | P2 | S11 | 🟡 **EN PROGRESO EN GAIS** (Pausado por límite de cuota) |
| **S13**| **PILOTO PROINTECA END-TO-END (Propanoducto Cardón-Amuay)** | P0 comercial | S6, S8, S9, S10 | 🟢 Listo para ejecutar tras cuota |
