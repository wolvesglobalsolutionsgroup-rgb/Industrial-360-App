...
export default function Documents() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const storagePath = `organizations/${currentOrganization?.id || 'default_org'}/projects/${currentProject.id}/docs/${fileUuid}_${file.name}`;
      ...
      uploadTask.on(
        ...
        async () => {
          ...
          await addDoc(collection(db, 'documents'), {
            ...
            orgId: currentOrganization?.id || 'default_org',
            name: file.name,
            size: file.size,
