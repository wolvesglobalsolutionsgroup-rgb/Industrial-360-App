...
export const MODULE_CATEGORIES: ModuleCategory[] = [
  {
    ...
    modules: [
      ...
      { id: 'apu-estimation', path: '/apu-estimation', title: 'Estimación APU & BC3', description: 'APU 4 rubros, FCAS CPTT, escalatorias y cómputos SIDCON', icon: Calculator, badge: 'BC3/SIDCON', badgeColor: 'amber' },
