...
export function calculateB165Flange(rating: string, nps: string): (FlangeSpec & { disclaimer: string }) | undefined {
  const spec = getFlangeSpec(rating, nps);
...
export class ASMEB165Calculator implements NormCalculator<Record<string, any>, NormResult[]> {
  id = 'asme_b165';
  standard = 'ASME B16.5';
  edition = '2020';
